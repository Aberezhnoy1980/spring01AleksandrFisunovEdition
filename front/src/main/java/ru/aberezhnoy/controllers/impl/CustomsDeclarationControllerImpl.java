package ru.aberezhnoy.controllers.impl;
...
import ru.aberezhnoy.controllers.CustomsDeclarationController;
import ru.aberezhnoy.converters.CustomsDeclarationConverter;
import ru.aberezhnoy.converters.PageConverter;
...
import ru.aberezhnoy.exceptions.AppError;
...
public class CustomsDeclarationControllerImpl implements CustomsDeclarationController {
    ...
    @GetMapping
    public PageDto<CustomsDeclarationResponse> getAllCustomsDeclaration(
        ...
        Page<CustomsDeclaration> customsDeclarations = customsDeclarationServices.findAll(page - 1, pageSize, sortBy, numberPart);
    ...
    @GetMapping("/export")
    public ResponseEntity<InputStreamResource> exportCustomsDeclarations(@RequestHeader @Parameter(description = "ИНН компании", required = false) String vatCode) {
